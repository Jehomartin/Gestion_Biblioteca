...
<div class="container">
    <font color="black" face="Sylfaen" class="text text-center">
        ...
        <h2>BIENVENIDO <?php echo e(Session::get('usuario')); ?></h2>
        <hr>
        <h3>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Gestion_Biblioteca\resources\views/admin/index.blade.php ENDPATH**/ ?>