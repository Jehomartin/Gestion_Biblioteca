 ...
 <div id="Editoriales" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="">
      ...
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
          ...
          <!-- fin footer modal EDITORIALES -->
        </div> <!-- fin modal content -->
      </div>  <!--/modal dialog -->
    </div> <!-- FINALIZA MODAL EDITORIALES -->


 <!-- CODIICACIÓN DEL MODAL AUTORES -->
 <!-- inicio ventana modal -->
 <div id="Autor" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
          <!-- se inicia el encabezado de la ventana modal -->
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLiveLabel" v-if="!editando"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">REGISTRANDO AUTOR</font></font></h5>
            <h5 class="modal-title" id="exampleModalLiveLabel" v-if="editando"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Editando Autor</font></font></h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" v-on:click="cancelarEdit()">
              <span aria-hidden="true"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">×</font></font></span>
            </button>
            <!-- <span aria-hidden="true">&times;</span> -->
          ...
          <div class="form-group">
                    ...
                    <input type="text" name="" placeholder="Autor del libro" class="form-control" v-model="autores">
              </div>
          </div>
          <!-- footer modal -->
          <div class="modal-footer div1">
    ...
    </div> <!-- FINALIZA EL MODAL AUTORES -->

        <!-- CODIICACIÓN DEL MODAL CARRERA -->
 <!-- inicio ventana modal -->
 <div id="Carrera" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="">
      ...
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
          <!-- se inicia el encabezado de la ventana modal -->
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLiveLabel" v-if="!editando"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">REGISTRANDO CARRERA</font></font></h5>
            <h5 class="modal-title" id="exampleModalLiveLabel" v-if="editando"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Editando Carrera</font></font></h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" v-on:click="cancelarEdit()">
              <span aria-hidden="true"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">×</font></font></span>
            </button>
            <!-- <span aria-hidden="true">&times;</span> -->
          ...
          <div class="modal-body div1">
          <div class="form-group">
                    <label for="Carreras">Carrera pertenece el libro</label>
                    <input type="text" name="" placeholder="Carrera Pertenece" class="form-control" v-model="carreras">
              </div>
          </div>
          <!-- footer modal -->
          <div class="modal-footer div1">
    ...
    </div> <!-- FINALIZA MODAL CARRERA -->

  <!-- CODIICACIÓN DEL MODAL PAISES -->
 <!-- inicio ventana modal -->
 <div id="Pais" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
          <!-- se inicia el encabezado de la ventana modal -->
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLiveLabel" v-if="!editando"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">REGISTRANDO PAIS  </font></font></h5>
            <h5 class="modal-title" id="exampleModalLiveLabel" v-if="editando"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Editando Pais</font></font></h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" v-on:click="cancelarEdit()">
              <span aria-hidden="true"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">×</font></font></span>
            </button>
            <!-- <span aria-hidden="true">&times;</span> -->
          ...
          <div class="modal-body div1">
          <div class="form-group">
                    <label for="Paises">Pais del libro</label>
                    <input type="text" name="" placeholder="Pais del libro" class="form-control" v-model="paises">
              </div>
          </div>
          <!-- footer modal -->
          <div class="modal-footer div1">
